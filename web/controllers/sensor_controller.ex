defmodule MagpiePresenter.SensorController do
  ...
  def get_data(conn, params) do
    ...
    Timex.Date.set(from, [hour: 0, minute: 0, second: 0, ms: 0, validate: false])
    Timex.Date.set(to, [hour: 0, minute: 0, second: 0, ms: 0, validate: false])

    measurements = Magpie.DataAccess.Measurement.get(params["id"], from, from, to)
